...
![在这里插入图片描述](/img/b140e7e7886645fd8153031432664c74.png)
...
![在这里插入图片描述](/img/54a8fb9c34824457ab3892aee0cb9f84.png)
...
![在这里插入图片描述](/img/363dec452c7e46438756099056392e8d.png)  
![在这里插入图片描述](/img/7776ff77beed4eaea3930a5be4305bc1.png)

+   方法的标准定义格式

![在这里插入图片描述](/img/34a9bb46d7ee4b2c8167dc22201ed122.png)

+   方法调用的三种格式

![在这里插入图片描述](/img/d541cc7e762f480fae08e54e2c118b2e.png)
...
![在这里插入图片描述](/img/1e6296ccb4e54701a795cc90c34ea9d2.png)

+   对比方法有参数和无参数

![在这里插入图片描述](/img/814f99a427a445d586922b71d3e1e79a.png)

+   方法的重载

![在这里插入图片描述](/img/ff61ca4a9df742cc94bc698886c15b64.png)

### 2.面对对象-初步了解

+   面对对象与面对过程

![在这里插入图片描述](/img/7c8bd0f94f314f30b337b756bf5078b5.png)

+   类和对象  
    ![在这里插入图片描述](/img/8bfadf94c4d94fe3867fd46646cc0694.png)

### 2.类的定义

![在这里插入图片描述](/img/1e057b30cf124597a1703c10bf32dc2a.png)

`成员变量一般不赋值，在创建对象后再赋值`

### 3.创建对象及其使用

![在这里插入图片描述](/img/d4c982ec5ae9480997e3542678e421c5.png)
...
![在这里插入图片描述](/img/81241859ca354315b5b13f81c717f5a1.png)

+   两个对象使用同一个方法的内存图(○1的重复)

![在这里插入图片描述](/img/be3babd4a42040ce9291ec701c9d32cd.png)

+   两个对象引用指向同一个对象的内存图(注意栈内存中phone one 指向 phone two的箭头)

![在这里插入图片描述](/img/911486e5e5e54e11b479ab20c2c0f294.png)

### 5.使用对象作为方法的参数

![在这里插入图片描述](/img/86643fcf71cc44f0bcabf6afb284c310.png)  
![在这里插入图片描述](/img/d0a71ee55002459a85899fa70b2b7758.png)

### 6.成员变量和局部变量的区别

![在这里插入图片描述](/img/f47a1572f87e4cacb9455c65e0ac0667.png)
...
+   方法的封装  
    ![在这里插入图片描述](/img/3db1acde5b004c15bff741e3eb6b7c55.png)
    
+   private关键字的封装
    

![在这里插入图片描述](/img/26054af704844ce3834d8cce82b9c7e8.png)  
![在这里插入图片描述](/img/42a217fb655a443098048cc4750ff30a.png)
...
![在这里插入图片描述](/img/3ffe0a0044824c8ba2be50b23cf0359e.png)

### 10.定义一个标准的类

![在这里插入图片描述](/img/91d2e4791ef4494d9baf0c598ec8a6c5.png)

### 11.静态关键字static

+   静态关键字static初步了解

![在这里插入图片描述](/img/69854be1fdb1433889b44009ef7053df.png)

+   静态static关键字修饰成员变量

![在这里插入图片描述](/img/02f4a6c5f7c14615a0fd7715753c3408.png)

+   静态static关键字修饰成员方法

![在这里插入图片描述](/img/1bd0c4c66a1843bdb1607b0b7adf76e7.png)

+   静态static的内存图

![在这里插入图片描述](/img/f5eda6b9b2ed4a4fb009071c1e524bca.png)

+   静态代码块

![在这里插入图片描述](/img/e16b2f2bf429407ab3e3cabfb082de26.png)
...
![在这里插入图片描述](/img/f8cadb64df4d40879468b60abde061ef.png)
...
![在这里插入图片描述](/img/eedef05d788a4e60bc29ff455af80e48.png)  
![在这里插入图片描述](/img/fdd5b15937b344ddaaae02f8086d6996.png)
...
![在这里插入图片描述](/img/8229d24291a3498b9c31ecbe1500510b.png)

### 2.继承的格式

![在这里插入图片描述](/img/886f248bba4c4c50b762700cbf6e2522.png)

### 3.继承中成员变量访问的特点

![在这里插入图片描述](/img/9a5d5ec7b7b742d7a9870b5ac64e7c70.png)  
![在这里插入图片描述](/img/a3cd3ca2c1de485d951941e235cdb317.png)

![在这里插入图片描述](/img/d630144853764eabb98c26d245bb7cd1.png)![在这里插入图片描述](/img/be71d8a4220e489587d055efcdc65919.png)

### 4.区分子类方法中重名的三种变量

![在这里插入图片描述](/img/346383a4170b435893ce6c191ae4035a.png)  
![在这里插入图片描述](/img/16bfb0e2385942919ce5a2058b269589.png)

![在这里插入图片描述](/img/8593583dfdf040e791f63dc6dccbe496.png)

![在这里插入图片描述](/img/6bdfca5ed63f4e44ae70fa89f847647c.png)

### 5.继承中成员方法的访问特点

![在这里插入图片描述](/img/f5f09d62bc0b44879508aa286197d3d4.png)![在这里插入图片描述](/img/544bd89e6464491daa61352a6eca15c3.png)

![在这里插入图片描述](/img/60c80ca7fd314eb6bd7d815defbb1488.png)

### 6.方法的覆盖重写

+   基础概念  
    ![在这里插入图片描述](/img/28411fb7825e491e9100c4b0492fcfb0.png)
...
![在这里插入图片描述](/img/686164a1b3044b0584ea16630c3d73af.png)  
Private方法不能覆盖。只有非private的实例方法才可以覆盖，如果在子类中定义了一个方法在父类中是private的，则这两个方法无关；
...
![在这里插入图片描述](/img/c9c044dc506d4174aad103b01957cd36.png)

### 7.构造方法在覆盖重写中的访问特点

![在这里插入图片描述](/img/86a1c30f88d64bab88066de6ab0463a2.png)

### 8.super关键字与this的比较

+   super关键字的三种用法

![在这里插入图片描述](/img/3c63859e7053466194b6a43a22c9e78d.png)

+   this关键字的用法

![在这里插入图片描述](/img/32b2fb9101c84f829172217fda940069.png)  
![在这里插入图片描述](/img/bb169383564245e89b3d9674136d8159.png)

+   super关键字和this关键字的内存图

![在这里插入图片描述](/img/ca1dc4bd72054c538978fa9e7b1b0733.png)

### 9.java继承中的特点

![在这里插入图片描述](/img/1dbd38e2d3284d0a91135b4b3209bb7a.png)
...
+   抽象的概念初步了解  
    ![在这里插入图片描述](/img/d6f9deda8b9e497e9f339b9631fe0e06.png)
    
+   抽象方法与抽象类的定义格式
    

![在这里插入图片描述](/img/bdf888696abc4ca497494c12b1836ae6.png)

+   抽象方法的使用

![在这里插入图片描述](/img/0357c0196aa74a369843bef2e1febea3.png)

+   抽象类与抽象方法的注意事项

![在这里插入图片描述](/img/b339533cd6494b31980dbd1ef3c4407f.png)
...
![在这里插入图片描述](/img/c599f6f9402c48178fdfed13143ded00.png)

### 2.接口的基本定义格式

![在这里插入图片描述](/img/a4c0d31c726943d7ae06e91a26225c2c.png)

### 3.接口的抽象方法定义

![在这里插入图片描述](/img/6434c63731ff4a53b8f683717a425100.png)

### 4.接口中抽象方法的实现（接口的实现）

![在这里插入图片描述](/img/2f5029c10bcb462e891b4335216d6707.png)

### 5.接口中的默认方法

+   初步了解（接口升级，类AB报错）

![在这里插入图片描述](/img/097b7ae25c364aaeb888af399ab1f1b0.png)![在这里插入图片描述](/img/c4a5eaf3afdc4d1ba2c2817decf29e6f.png)

+   接口中默认方法的实现(类AB不变，但可调用default方法)

![在这里插入图片描述](/img/58e6ee14a0e94cafaa4552ea296c51b1.png)![在这里插入图片描述](/img/08dcdbbd4d0a44a59dc84cd170de7f9d.png)

![在这里插入图片描述](/img/ff438b98657045bf9c02118f81a6629b.png)  
![在这里插入图片描述](/img/1c69590224474d81bddb27e3eb7308a4.png)

![在这里插入图片描述](/img/dc497c74dca941149322044c8f965641.png)
